...
CREATE TABLE `task` (
  ...
  `status` enum('not started','in progress','done') COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`task_id`)
...
CREATE TABLE `user_has_task` (
  `fk_user_id` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `fk_task_id` varchar(50) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-04-08 15:42:21
